/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/mk-build1/haotian/LE11_LATEST_AP/oe-core/build/tmp-glibc/work-shared/gcc-4.9.2-r0/gcc-4.9.2/gcc/config/arm/arm.md'.  */
