...
========================================================================== */
/* $Header: //source/qcom/qct/multimedia2/Audio/audcal4/acdb_sw/main/latest/acdb/inc/acdb.h#22 $ */
...
- ACDB_INPUT_PARAMS_NOT_FOUND -- Provided input parameters were not found
in the ACDB.
- ACDB_DATA_INTERFACE_NOT_FOUND \96 ACDB files does not contain this interface.
...
typedef struct _AcdbVocColumnsInfoSizeCmdType_V2 {
	...
	uint32_t nTxDeviceId;
	/**< Tx device ID. *///IF the table id is vocstrm or vocstrmstatic this value is a don\92t care value
	uint32_t nRxDeviceId;
	/**< Rx device ID. *///IF the table id is vocstrm or vocstrmstatic this value is a don\92t care value
