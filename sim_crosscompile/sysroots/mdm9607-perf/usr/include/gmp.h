...
#define __GMP_CC "arm-oe-linux-gnueabi-gcc  -march=armv7-a -mfloat-abi=softfp -mfpu=neon --sysroot=/home/mk-build1/haotian/LE11_LATEST_AP/oe-core/build/tmp-glibc/sysroots/mdm9607"
#define __GMP_CFLAGS "-marm -O2 -pedantic -fomit-frame-pointer  -O2 -fexpensive-optimizations -frename-registers -fomit-frame-pointer -fstack-protector-all -D_FORTIFY_SOURCE=2"
