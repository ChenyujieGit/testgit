...
int snd_use_case_mgr_get_sidet(int rxacdb_id, int txacdb_id, unsigned int *acdb_data);

int snd_use_case_mgr_set_sidet(int rxacdb_id, int txacdb_id, unsigned int acdb_data);

int snd_use_case_mgr_set_sidet_real(int rxacdb_id, int txacdb_id, unsigned int acdb_data);

int snd_acdb_get_vol(unsigned char *Volume);

int snd_acdb_set_vol(unsigned char *Volume);

int snd_acdb_get_tx_mic_gain(unsigned char *enable,unsigned char *micGain);

int snd_acdb_set_tx_mic_gain(unsigned char *enable,unsigned char *micGain);

int snd_acdb_get_rx_vol(unsigned char *Volume);

int snd_acdb_set_rx_vol(unsigned char *Volume);

int snd_acdb_get_cech(unsigned char *gain);

int snd_acdb_set_cech(unsigned char *gain);

int snd_acdb_get_cecdt(unsigned char *gain);

int snd_acdb_set_cecdt(unsigned char *gain);

int snd_acdb_get_cecwb(unsigned char *gain);

int snd_acdb_set_cecwb(unsigned char *gain);

int snd_acdb_get_cnsn(unsigned char *gain);

int snd_acdb_set_cnsn(unsigned char *gain);

int snd_acdb_get_cnslim(unsigned char *gain);

int snd_acdb_set_cnslim(unsigned char *gain);

int snd_acdb_get_cfnsmod(unsigned char *gain);

int snd_acdb_set_cfnsmod(unsigned char *gain);

int snd_acdb_get_cfnsin(unsigned char *gain);

int snd_acdb_set_cfnsin(unsigned char *gain);

int snd_acdb_get_cfnslvl(unsigned char *gain);

int snd_acdb_set_cfnslvl(unsigned char *gain);

int snd_acdb_get_cecrx(unsigned char *enable);

int snd_acdb_set_cecrx(unsigned char *enable);

int snd_acdb_get_cnlppg(unsigned char *gain);

int snd_acdb_set_cnlppg(unsigned char *gain);

int snd_acdb_get_cnlppl(unsigned char *gain);

int snd_acdb_set_cnlppl(unsigned char *gain);

int snd_acdb_set_cecm(int value);
