...
our %config = (
  ...
  ARFLAGS => [ "r" ],
  CC => "gcc",
  CFLAGS => [ "-Wall -O3", "--sysroot=/home/chenyujie/learngit/sim_crosscompile/sysroots/mdm9607-perf" ],
  CPPDEFINES => [  ],
  CPPFLAGS => [  ],
  CPPINCLUDES => [  ],
  CROSS_COMPILE => "arm-oe-linux-gnueabi-",
  CXX => "g++",
  CXXFLAGS => [ "-Wall -O3", "--sysroot=/home/chenyujie/learngit/sim_crosscompile/sysroots/mdm9607-perf" ],
  ...
  openssldir => "",
  options => "--prefix=/home/chenyujie/learngit/openssl-1.1.1c/output --cross-compile-prefix=arm-oe-linux-gnueabi- --sysroot=/home/chenyujie/learngit/sim_crosscompile/sysroots/mdm9607-perf no-asan no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.26.1",
  perlargv => [ "linux-armv4", "--prefix=/home/chenyujie/learngit/openssl-1.1.1c/output", "--cross-compile-prefix=arm-oe-linux-gnueabi-", "--sysroot=/home/chenyujie/learngit/sim_crosscompile/sysroots/mdm9607-perf" ],
  perlenv => {
      "AR" => undef,
      "BUILDFILE" => undef,
      "CC" => undef,
  ...
  prefix => "/home/chenyujie/learngit/openssl-1.1.1c/output",
  processor => "",
