...
#define DATE "built on: Wed Aug 17 02:35:48 2022 UTC"
...
static const char compiler_flags[] = {
    'c','o','m','p','i','l','e','r',':',' ','a','r','m','-','o','e',
    '-','l','i','n','u','x','-','g','n','u','e','a','b','i','-','g',
    'c','c',' ','-','f','P','I','C',' ','-','p','t','h','r','e','a',
    'd',' ','-','W','a',',','-','-','n','o','e','x','e','c','s','t',
    'a','c','k',' ','-','W','a','l','l',' ','-','O','3',' ','-','-',
    's','y','s','r','o','o','t','=','/','h','o','m','e','/','c','h',
    'e','n','y','u','j','i','e','/','l','e','a','r','n','g','i','t',
    '/','s','i','m','_','c','r','o','s','s','c','o','m','p','i','l',
    'e','/','s','y','s','r','o','o','t','s','/','m','d','m','9','6',
    '0','7','-','p','e','r','f',' ','-','D','O','P','E','N','S','S',
